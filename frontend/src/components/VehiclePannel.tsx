...
const VehiclePannel: React.FC<VehiclePannelProps> = ({ setVehiclePanel }) => {
  return (
    <>
      <h5
        onClick={() => {
      ...
      <div className="w-full mb-2 p-3 border-2 active:border-black bg-gray-100 rounded-xl flex justify-center ite">
        <img
          className="h-10"
